...
=== 답변 목록 조회
.curl-request
include::{snippets}/get-qanswer/curl-request.adoc[]

.http-request
include::{snippets}/get-qanswer/http-request.adoc[]

.request-parameters
include::{snippets}/get-qanswer/request-parameters.adoc[]

.http-response
include::{snippets}/get-qanswer/http-response.adoc[]

.response-fields
include::{snippets}/get-qanswer/response-fields.adoc[]
